...
/* harmony import */ var _components_blik__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/blik */ "./src/js/components/blik.js");
/* harmony import */ var _components_blik__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_blik__WEBPACK_IMPORTED_MODULE_2__);
...
function blikInit(el, params) {
  ...
  */
  ...
  lineargradient.addColorStop(0.3, 'rgba(255, 255, 255, 0.9)');
  lineargradient.addColorStop(0.5, 'rgba(255, 255, 255, 1)');
  lineargradient.addColorStop(0.7, 'rgba(255, 255, 255, 0.9)');
  ...
  function render() {
    ...
    for (var n = 0; n < words.length; n++) {
      ...
      if (testWidth > elW) {
        line = words[n] + " ";
        marginTop += parseInt(optLineHeight);
      } else {
        line = testLine;
      }
      ctx.fillText(line, 0, marginTop);
    }

    //  var gradient = ctx.createLinearGradient(20, 0, testWidth-elW+20, elH);
    //  gradient.addColorStop(0.0, 'rgba(39, 21, 0, 1)');
    //  gradient.addColorStop(0.3, 'rgba(156, 94, 50, 1)');
    //  gradient.addColorStop(0.5, 'rgba(234, 205, 144, 1)');
    //  gradient.addColorStop(0.7, 'rgba(156, 94, 50, 1)');
    //  gradient.addColorStop(1.0, 'rgba(39, 21, 0, 1)');
    ...
    ctx.fillRect(0, -50, blikWidth, elH + 100);
    ctx.restore();
...
// слайдер
const swiperReviews = new Swiper('.swiper__certificate', {
  pagination: {
...
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.consultation__form', rules, afterForm);
